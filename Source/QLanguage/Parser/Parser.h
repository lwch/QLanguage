...
#define GLOBAL_FUNCTION_DESC_TEMPLATE_DESC_TYPE_DESC_PARAM_LIST_BLOCK    60  // global_function_desc -> template_desc type_desc "{Letter}" "(" paramter_list ")" block
#define GLOBAL_FUNCTION_DESC_TYPE_DESC_PARAM_LIST_BLOCK                  61  // global_function_desc -> type_desc "{Letter}" "(" paramter_list ")" block
#define GLOBAL_FUNCTION_DESC_TEMPLATE_DESC_TYPE_DESC_NOPARAM_BLOCK       62  // global_function_desc -> template_desc type_desc "{Letter}" "(" ")" block
#define GLOBAL_FUNCTION_DESC_TYPE_DESC_NOPARAM_BLOCK                     63  // global_function_desc -> type_desc "{Letter}" "(" ")" block
#define GLOBAL_FUNCTION_DESC_TEMPLATE_DESC_VOID_PARAM_LIST_BLOCK         64  // global_function_desc -> template_desc "void" "{Letter}" "(" paramter_list ")" block
#define GLOBAL_FUNCTION_DESC_VOID_PARAM_LIST_BLOCK                       65  // global_function_desc -> "void" "{Letter}" "(" paramter_list ")" block
#define GLOBAL_FUNCTION_DESC_TEMPLATE_DESC_VOID_NOPARAM_BLOCK            66  // global_function_desc -> template_desc "void" "{Letter}" "(" ")" block
#define GLOBAL_FUNCTION_DESC_VOID_NOPARAM_BLOCK                          67  // global_function_desc -> "void" "{Letter}" "(" ")" block
#define FUNCTION_DECLARE_TEMPLATE_DESC_TYPE_DESC_PARAM_LIST              68  // function_declare -> template_desc type_desc "{Letter}" "(" paramter_list ")" ";"
#define FUNCTION_DECLARE_TYPE_DESC_PARAM_LIST                            69  // function_declare -> type_desc "{Letter}" "(" paramter_list ")" ";"
#define FUNCTION_DECLARE_TEMPLATE_DESC_TYPE_DESC                         70  // function_declare -> template_desc type_desc "{Letter}" "(" ")" ";"
#define FUNCTION_DECLARE_TYPE_DESC                                       71  // function_declare -> type_desc "{Letter}" "(" ")" ";"
#define FUNCTION_DECLARE_TEMPLATE_DESC_VOID_PARAM_LIST                   72  // function_declare -> template_desc "void" "{Letter}" "(" paramter_list ")" ";"
#define FUNCTION_DECLARE_VOID_PARAM_LIST                                 73  // function_declare -> "void" "{Letter}" "(" paramter_list ")" ";"
#define FUNCTION_DECLARE_TEMPLATE_DESC_VOID                              74  // function_declare -> template_desc "void" "{Letter}" "(" ")" ";"
#define FUNCTION_DECLARE_VOID                                            75  // function_declare -> "void" "{Letter}" "(" ")" ";"
...
#define FUNCTION_DESC_TEMPLATE_DESC_ATTRIBUTE_TYPE_DESC_PARAM_LIST_BLOCK 97  // function_desc -> template_desc attribute type_desc "{Letter}" "(" paramter_list ")" block
...
#define FUNCTION_DESC_TEMPLATE_DESC_TYPE_DESC_PARAM_LIST_BLOCK           99  // function_desc -> template_desc type_desc "{Letter}" "(" paramter_list ")" block
#define FUNCTION_DESC_TYPE_DESC_PARAM_LIST_BLOCK                         100 // function_desc -> type_desc "{Letter}" "(" paramter_list ")" block
#define FUNCTION_DESC_TEMPLATE_DESC_ATTRIBUTE_TYPE_DESC_BLOCK            101 // function_desc -> template_desc attribute type_desc "{Letter}" "(" ")" block
#define FUNCTION_DESC_ATTRIBUTE_TYPE_DESC_BLOCK                          102 // function_desc -> attribute type_desc "{Letter}" "(" ")" block
#define FUNCTION_DESC_TEMPLATE_DESC_TYPE_DESC_BLOCK                      103 // function_desc -> template_desc type_desc "{Letter}" "(" ")" block
#define FUNCTION_DESC_TYPE_DESC_BLOCK                                    104 // function_desc -> type_desc "{Letter}" "(" ")" block
#define FUNCTION_DESC_TEMPLATE_DESC_ATTRIBUTE_VOID_PARAM_LIST_BLOCK      105 // function_desc -> template_desc attribute "void" "{Letter}" "(" paramter_list ")" block
#define FUNCTION_DESC_ATTRIBUTE_VOID_PARAM_LIST_BLOCK                    106 // function_desc -> attribute "void" "{Letter}" "(" paramter_list ")" block
#define FUNCTION_DESC_TEMPLATE_DESC_VOID_PARAM_LIST_BLOCK                107 // function_desc -> template_desc "void" "{Letter}" "(" paramter_list ")" block
#define FUNCTION_DESC_VOID_PARAM_LIST_BLOCK                              108 // function_desc -> "void" "{Letter}" "(" paramter_list ")" block
#define FUNCTION_DESC_TEMPLATE_DESC_ATTRIBUTE_VOID_BLOCK                 109 // function_desc -> template_desc attribute "void" "{Letter}" "(" ")" block
#define FUNCTION_DESC_ATTRIBUTE_VOID_BLOCK                               110 // function_desc -> attribute "void" "{Letter}" "(" ")" block
#define FUNCTION_DESC_TEMPLATE_DESC_VOID_BLOCK                           111 // function_desc -> template_desc "void" "{Letter}" "(" ")" block
#define FUNCTION_DESC_VOID_BLOCK                                         112 // function_desc -> "void" "{Letter}" "(" ")" block
